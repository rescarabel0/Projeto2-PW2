...
<body>
    <section class="alert alert-danger" role="alert">
        <h1>Excluir o jogo #<?php echo $jogo[0]['id']; ?>?</h1>
        <hr>
    </section>
    <section class="container">
        <form method="POST" action="">
            <div class="mb-3">
                ...
                <input class="form-control" id="titulo" type="text" name="titulo" value="<?php echo $jogo[0]['titulo']; ?>" readonly>
                <?php
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="produtora" type="text" name="produtora" value="<?php echo $jogo[0]['produtora']; ?>" readonly>
                <?php
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" id="preco" type="number" min="0" max="400" name="preco" step=".5" value="<?php echo $jogo[0]['preço_lançamento']; ?>" readonly>
                    <span class="input-group-text" id="basic-addon3">.00</span>
                </div>               
            </div>
            <div class="mb-3">
                <label class="form-label" for="date">Data de lançamento:</label>
                <input class="form-control" id="date" type="date" name="date" value="<?php echo $jogo[0]['data_lançamento']; ?>" readonly>
                <?php
            ...
            <div class="mb-3">
                ...
                <select name="categ" id="categ" class="form-select" disabled>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="sinopse" name="sinopse" rows="6" readonly><?php echo $jogo[0]['sinopse']; ?></textarea>
                <?php
            ...
            <div class="mb-3">
                ...
                <input type="submit" name="btnOperacao" value="Excluir" class="btn btn-success btn-lg" id="submitbtn"> &nbsp; &nbsp;
            </div>
        </form>
    </section>
